...
namespace SlackSDK.API
{
    public partial class SlackAPI
    {
        ...
        public async Task<bool> DeleteMessage(float messageTimestamp, string channelID)
        {
        ...
        public async Task<UpdateMessageResponse> UpdateMessage(float messageTimestamp, string channelID, string newText)
        {
